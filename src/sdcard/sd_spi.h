...
/*****************************************************************************
  ...
  ***************************************************************************************/
enum Status SD_SPI_sector_read(uint32_t sector_address, uint8_t* buffer, uint16_t sector_count);
...
/*****************************************************************************
  ...
  Remarks:
    ...
    times (multiplying by 512).
  ***************************************************************************************/
enum Status SD_SPI_sector_write(uint32_t sector_address, const uint8_t* buffer, uint16_t sector_count);
